...
module.exports = createRequestTrigger({
  ...
  helpText:
    'Choose the form whose requests should fire this Zap. A completed request fires this trigger alone, never the Submission trigger, so a Zap on each receives one event per completion.',
})
